...
replace (
	...
	open-cluster-management.io/multicloud-operators-placementrule => open-cluster-management.io/multicloud-operators-placementrule v1.2.4-0-20210816-699e5.0.20211012154812-5fac6c25d2f6
)
